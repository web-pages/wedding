	...
	function initialize() {
		...
		//=======================================================================================
  		var mapOptions = {
    		...
    		center: new google.maps.LatLng(43.317316, -1.991598),
			panControl: true,
  			zoomControl: true,
  			mapTypeControl: true,
  			//scaleControl: false,
		...
		/*var marker1 = new MarkerWithLabel({
       		position: new google.maps.LatLng(43.318332, -1.985157),
       		draggable: false,
       		raiseOnDrag: false,
       		icon: ' ',
       		map: map, 
         	labelContent: '<div class="de-icon circle small-size inline" style="background-color:#0d9a48"><i class="de-icon-home-1" style="color:#FFF"></i></div>',
       		labelAnchor: new google.maps.Point(29, 20),
       		labelClass: "labels" // the CSS class for the label
     		});*/
    
		var marker2 = new MarkerWithLabel({
       		position: new google.maps.LatLng(43.318332, -1.985),
       		draggable: false,
       		raiseOnDrag: false,
       		icon: ' ',
       		map: map, 
		...
		var marker5 = new MarkerWithLabel({
       		position: new google.maps.LatLng(43.314801, -1.998400),
       		draggable: false,
       		raiseOnDrag: false,
       		icon: ' ',
       		map: map, 
